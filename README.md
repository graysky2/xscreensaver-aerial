...
* ![logo](http://www.monitorix.org/imgs/archlinux.png "arch logo") [xscreensaver-aerial-videos-2k](https://aur.archlinux.org/packages/xscreensaver-aerial-videos-2k) - 2k videos require approx 16.3 GB of space.
* ![logo](http://www.monitorix.org/imgs/archlinux.png "arch logo") [xscreensaver-aerial-videos-4k](https://aur.archlinux.org/packages/xscreensaver-aerial-videos-4k) - 4k videos require approx 32.2 GB of space.
...
for i in "${twok[@]}"; do
	wget --no-check-certificate --no-clobber https://sylvan.apple.com/Aerials/2x/Videos/"$i"
done
